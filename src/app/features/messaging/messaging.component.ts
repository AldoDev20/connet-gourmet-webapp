import { Component, OnInit, ElementRef, ViewChild, AfterViewChecked, ChangeDetectionStrategy } from '@angular/core';
        ...
        <section class="w-full md:w-80 lg:w-96 bg-surface border-r border-outline-variant flex flex-col h-full shrink-0">
          ...
          <div class="flex-1 overflow-y-auto custom-scrollbar">
            ...
            @if (chats$ | async; as chats) {
              @for (chat of filterConversations(chats); track chat) {
                <div
              ...
              <!-- Empty state -->
              @if (chats.length === 0) {
                <div class="p-8 text-center text-outline-variant">
