  ...
  template: `
    ...
    <main class="max-w-container-max mx-auto pt-24 px-margin-desktop flex gap-gutter bg-surface min-h-screen text-on-surface">
      ...
      <section class="flex-1 lg:ml-64 max-w-2xl mx-auto space-y-6">
          ...
          <div class="flex gap-4">
            ...
            <div class="flex-1">
              ...
              <div class="mt-3 space-y-2">
                ...
                <div *ngIf="selectedLocation" class="inline-flex items-center gap-1 bg-secondary-fixed text-on-secondary-fixed-variant px-3 py-1 rounded-full text-xs font-semibold">
                ...
                <div *ngIf="selectedIngredients.length > 0" class="flex flex-wrap gap-1.5 mt-2">
                  <span *ngFor="let ing of selectedIngredients" class="inline-flex items-center gap-1 bg-tertiary-fixed text-on-tertiary-fixed-variant px-3 py-1 rounded-full text-xs font-semibold">
                ...
                <!-- Photo preview -->
                <div *ngIf="selectedImage" class="relative rounded-2xl overflow-hidden aspect-video border border-outline-variant/30 mt-2 max-h-48 w-fit group">
                ...
                <div *ngIf="selectedVideo" class="relative rounded-2xl overflow-hidden aspect-video bg-black/10 flex items-center justify-center border border-outline-variant/30 mt-2 max-h-48 w-80 group">
          ...
          <div class="flex flex-wrap justify-between items-center mt-4 pt-4 border-t border-surface-container">
            <div class="flex gap-2">
              ...
              <div class="relative inline-block">
                ...
                <div *ngIf="showIngredientsDropdown" class="absolute bg-white border border-outline-variant/30 rounded-2xl shadow-xl p-4 z-20 mt-2 w-64 animate-fade-in left-0 top-full">
              ...
              <div class="relative inline-block">
                ...
                <div *ngIf="showLocationDropdown" class="absolute bg-white border border-outline-variant/30 rounded-2xl shadow-xl p-4 z-20 mt-2 w-48 animate-fade-in left-0 top-full">
        ...
        <!-- Posts Stream -->
        <div class="space-y-8 pb-10" *ngIf="postFacade.posts$ | async as posts">
          <article 
            *ngFor="let post of posts; trackBy: trackByPostId" 
            ...
            <!-- Post Media -->
            <div class="relative group" *ngIf="post.imageUrl">
              <img class="w-full aspect-square object-cover" [alt]="post.content" [src]="post.imageUrl"/>
              <div class="absolute bottom-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity" *ngIf="post.locationLabel || post.hasRecipe">
                <span class="bg-white/80 backdrop-blur-md px-3 py-1 rounded-full text-label-sm text-on-surface font-bold" *ngIf="post.locationLabel">
                  {{ post.locationLabel }}
                </span>
                <span class="bg-white/80 backdrop-blur-md px-3 py-1 rounded-full text-label-sm text-on-surface font-bold" *ngIf="post.hasRecipe">
                  RECETA
                </span>
              </div>
            </div>
            ...
            <!-- Video Player Mock -->
            <div class="relative aspect-video group" *ngIf="post.videoUrl && !post.imageUrl">
            ...
            <div class="p-6">
              ...
              <div *ngIf="post.ingredients && post.ingredients.length > 0" class="flex flex-wrap gap-1.5 mb-4">
                <span *ngFor="let ing of post.ingredients" class="inline-flex items-center gap-1 bg-tertiary/10 text-tertiary px-2.5 py-0.5 rounded-full text-xs font-bold">
              ...
              <!-- Tags if any -->
              <div class="flex gap-2 flex-wrap mb-4" *ngIf="post.creatorId === 'don-ricardo'">
              ...
              <!-- Comments Section -->
              <div class="mt-6 pt-6 border-t border-surface-container" *ngIf="showCommentsId === post.id">
                <div class="space-y-4 mb-4">
                  <div *ngFor="let comment of post.comments" class="flex gap-3 text-body-md">
