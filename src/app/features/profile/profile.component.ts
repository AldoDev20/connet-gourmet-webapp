  ...
  template: `
    ...
    <div class="flex max-w-container-max mx-auto pt-16 bg-surface min-h-screen text-on-surface">
      ...
      <main class="flex-1 lg:ml-64 px-4 md:px-margin-desktop py-8">
        <ng-container *ngIf="creatorFacade.creator$ | async as creator">
          ...
          <div class="flex flex-col lg:flex-row gap-gutter">
            ...
            <div class="flex-1">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-gutter" *ngIf="activeTab === 'posts'">
                <ng-container *ngIf="gastonPosts$ | async as gastonPosts">
                  <div 
                    *ngFor="let post of gastonPosts; let idx = index"
                    ...
                    <div class="overflow-hidden relative" [ngClass]="post.videoUrl && !post.imageUrl ? 'h-[420px]' : 'h-64'">
                      ...
                      <div class="absolute inset-0 bg-black/20 flex items-center justify-center" *ngIf="post.videoUrl">
                    ...
                    <div class="p-6">
                      <div class="flex items-center gap-2 mb-2" *ngIf="post.locationLabel">
                        ...
                        <span class="px-3 py-1 bg-tertiary-fixed text-on-tertiary-fixed-variant rounded-full text-label-sm font-semibold" *ngIf="idx === 2">
                          Sustainability Hero
                        </span>
                      </div>
              ...
              <!-- Other tabs display -->
              <div class="bg-white rounded-3xl p-8 border border-outline-variant/30 min-h-[300px] flex items-center justify-center" *ngIf="activeTab !== 'posts'">
            ...
            <aside class="w-full lg:w-80 flex flex-col gap-8">
              ...
              <div class="bg-surface-container-low rounded-[24px] p-6 border border-outline-variant">
                ...
                <ul class="flex flex-col gap-4" *ngIf="creatorFacade.producers$ | async as producers">
                  <li *ngFor="let producer of producers" class="flex items-center justify-between p-3 bg-white rounded-xl shadow-sm">
